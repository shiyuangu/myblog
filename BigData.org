...
3. prepare a local file with all necessary parameters and then copy the file to master. 
4.  deploy other user files (parameter /deploy_root_dir/) to master
5. run /setup_spark_cluster/, which run spark-ec2/setup.sh, spark-ec2/setup.sh
